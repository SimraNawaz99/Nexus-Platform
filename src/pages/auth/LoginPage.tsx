...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store role so 2FA page knows where to redirect after OTP
      localStorage.setItem('nexus_pending_role', role);
      // Redirect to 2FA step instead of dashboard directly
          ...
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-primary-600 text-white text-xs
                              flex items-center justify-center font-semibold">1</div>
              <span className="text-sm font-medium text-primary-600">Credentials</span>
            </div>
            <div className="flex-1 h-px bg-gray-300 max-w-[40px]" />
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-gray-200 text-gray-500 text-xs
                              flex items-center justify-center font-semibold">2</div>
              <span className="text-sm font-medium text-gray-400">Verify OTP</span>
            </div>
          </div>
