...
export const EntrepreneurDashboard: React.FC = () => {
  ...
  // Read wallet balance from localStorage (set by PaymentsPage)
  const [walletBalance, setWalletBalance] = useState<number>(() => {
    return Number(localStorage.getItem('nexus_wallet_balance') ?? 25000);
  });
  ...
  // Keep balance in sync if user navigates back from PaymentsPage
  useEffect(() => {
    const sync = () => {
      setWalletBalance(Number(localStorage.getItem('nexus_wallet_balance') ?? 25000));
    };
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        {/* ── Wallet balance card ── */}
        <Card className="bg-gradient-to-br from-primary-600 to-primary-800 border-0 shadow-md">
          <CardBody>
            <div className="flex items-center">
